// This is copyied from https://raw.githubusercontent.com/datopian/portaljs/main/packages/remark-callouts/src/lib/calloutTypes.ts
// which used for Obsidian's callout plugin

const fs = require("fs");
const path = require("path");

const spliter = "// The following is generated by ../scripts/callout-gen-style.js\n";
const calloutTypes = {
  // aliases
  summary: "abstract",
  tldr: "abstract",
...
fs.writeFileSync(path.resolve(__dirname, "../style/callout.less"), result.join("\n"));
